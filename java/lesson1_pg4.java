...
public class lesson1_pg4 extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_lesson1_pg4);}
    public void less1pg5(View view) {
        Intent intentpg5 = new Intent(this, lesson1_pg5.class);
        startActivity(intentpg5);
    }
    public void selector(View v) {
        ...
        CheckBox father = (CheckBox) findViewById(R.id.father);
        boolean fatherisselected = father.isChecked();
    ...
    void displaywrong() {
        ...
        TextView correctans = (TextView) findViewById(R.id.display_total4);
